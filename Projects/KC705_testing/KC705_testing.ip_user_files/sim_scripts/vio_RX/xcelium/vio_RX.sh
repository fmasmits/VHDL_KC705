...
#
# Script generated by Vivado on Wed Dec 18 09:15:08 CET 2024
...
#
# Usage        : vio_RX.sh
#                vio_RX.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_RX.sh [-reset_run]
#                vio_RX.sh [-reset_log]
#                vio_RX.sh [-help]
#
...
#                script (type 'vio_RX.sh -help' for more information).
#
...
# script info
echo -e "vio_RX.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_RX.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../KC705_testing.gen/sources_1/ip/vio_RX/hdl/verilog" +incdir+"../../../../KC705_testing.gen/sources_1/ip/vio_RX/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_RX xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_RX -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_RX_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_RX.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_RX.sh [-help]\n\
Usage: vio_RX.sh [-step]\n\
Usage: vio_RX.sh [-lib_map_path]\n\
Usage: vio_RX.sh [-reset_run]\n\
Usage: vio_RX.sh [-reset_log]\n\
Usage: vio_RX.sh [-keep_index]\n\
Usage: vio_RX.sh [-noclean_files]\n\n\
