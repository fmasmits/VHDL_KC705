...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../KC705_testing.gen/sources_1/ip/vio_RX/hdl/verilog" +incdir+"../../../../KC705_testing.gen/sources_1/ip/vio_RX/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_RX xil_defaultlib.glbl -o vio_RX_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_RX_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_RX_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_RX_simv.daidir vcs_lib c.obj)
