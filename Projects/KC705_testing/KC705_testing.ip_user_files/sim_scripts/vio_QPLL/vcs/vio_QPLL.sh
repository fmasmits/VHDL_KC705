...
#
# Script generated by Vivado on Tue Dec 17 14:53:29 CET 2024
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vio_QPLL.sh
...
#
# Usage        : vio_QPLL.sh
#                vio_QPLL.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_QPLL.sh [-reset_run]
#                vio_QPLL.sh [-reset_log]
#                vio_QPLL.sh [-help]
#
...
#                script (type 'vio_QPLL.sh -help' for more information).
#
...
# script info
echo -e "vio_QPLL.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_QPLL.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../sources/ip/vio_QPLL/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_QPLL/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_QPLL xil_defaultlib.glbl -o vio_QPLL_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_QPLL_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_QPLL_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_QPLL_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_QPLL.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_QPLL.sh [-help]\n\
Usage: vio_QPLL.sh [-step]\n\
Usage: vio_QPLL.sh [-lib_map_path]\n\
Usage: vio_QPLL.sh [-reset_run]\n\
Usage: vio_QPLL.sh [-reset_log]\n\
Usage: vio_QPLL.sh [-keep_index]\n\
Usage: vio_QPLL.sh [-noclean_files]\n\n\
