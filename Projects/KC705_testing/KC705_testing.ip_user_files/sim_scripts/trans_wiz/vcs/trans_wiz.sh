...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.trans_wiz xil_defaultlib.glbl -o trans_wiz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./trans_wiz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key trans_wiz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc trans_wiz_simv.daidir vcs_lib c.obj)
