...
#
# Script generated by Vivado on Wed Dec 18 15:30:09 CET 2024
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : trans_wiz.sh
...
#
# Usage        : trans_wiz.sh
#                trans_wiz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                trans_wiz.sh [-reset_run]
#                trans_wiz.sh [-reset_log]
#                trans_wiz.sh [-help]
#
...
#                script (type 'trans_wiz.sh -help' for more information).
#
...
# script info
echo -e "trans_wiz.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./trans_wiz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.trans_wiz xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.trans_wiz -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log trans_wiz_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./trans_wiz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: trans_wiz.sh [-help]\n\
Usage: trans_wiz.sh [-step]\n\
Usage: trans_wiz.sh [-lib_map_path]\n\
Usage: trans_wiz.sh [-reset_run]\n\
Usage: trans_wiz.sh [-reset_log]\n\
Usage: trans_wiz.sh [-keep_index]\n\
Usage: trans_wiz.sh [-noclean_files]\n\n\
