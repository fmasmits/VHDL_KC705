...
#
# Script generated by Vivado on Wed Dec 18 10:19:37 CET 2024
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vio_misc.sh
...
#
# Usage        : vio_misc.sh
#                vio_misc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_misc.sh [-reset_run]
#                vio_misc.sh [-reset_log]
#                vio_misc.sh [-help]
#
...
#                script (type 'vio_misc.sh -help' for more information).
#
...
# script info
echo -e "vio_misc.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_misc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../sources/ip/vio_misc/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_misc/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_misc xil_defaultlib.glbl -o vio_misc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_misc_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_misc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_misc_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_misc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_misc.sh [-help]\n\
Usage: vio_misc.sh [-step]\n\
Usage: vio_misc.sh [-lib_map_path]\n\
Usage: vio_misc.sh [-reset_run]\n\
Usage: vio_misc.sh [-reset_log]\n\
Usage: vio_misc.sh [-keep_index]\n\
Usage: vio_misc.sh [-noclean_files]\n\n\
