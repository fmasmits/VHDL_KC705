...
#
# Script generated by Vivado on Tue Dec 17 16:03:43 CET 2024
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vio_TRANS.sh
...
#
# Usage        : vio_TRANS.sh
#                vio_TRANS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_TRANS.sh [-reset_run]
#                vio_TRANS.sh [-reset_log]
#                vio_TRANS.sh [-help]
#
...
#                script (type 'vio_TRANS.sh -help' for more information).
#
...
# script info
echo -e "vio_TRANS.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_TRANS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../sources/ip/vio_TRANS/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_TRANS/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_TRANS xil_defaultlib.glbl -o vio_TRANS_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_TRANS_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_TRANS_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_TRANS_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_TRANS.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_TRANS.sh [-help]\n\
Usage: vio_TRANS.sh [-step]\n\
Usage: vio_TRANS.sh [-lib_map_path]\n\
Usage: vio_TRANS.sh [-reset_run]\n\
Usage: vio_TRANS.sh [-reset_log]\n\
Usage: vio_TRANS.sh [-keep_index]\n\
Usage: vio_TRANS.sh [-noclean_files]\n\n\
