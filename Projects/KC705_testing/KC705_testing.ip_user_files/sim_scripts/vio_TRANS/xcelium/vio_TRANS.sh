...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../sources/ip/vio_TRANS/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_TRANS/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_TRANS xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_TRANS -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_TRANS_sc.so .tmp_log xcelium_lib waves.shm c.obj)
