...
#
# Script generated by Vivado on Wed Dec 18 11:03:45 CET 2024
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_data_in.sh
...
#
# Usage        : ila_data_in.sh
#                ila_data_in.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_data_in.sh [-reset_run]
#                ila_data_in.sh [-reset_log]
#                ila_data_in.sh [-help]
#
...
#                script (type 'ila_data_in.sh -help' for more information).
#
...
# script info
echo -e "ila_data_in.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_data_in.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../sources/ip/ila_data_in/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_data_in xil_defaultlib.glbl -o ila_data_in_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_data_in_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fma_smits/documents/UU_afstuderen/VHDL_UU_KC705/SimulationLib"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ila_data_in_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_data_in_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_data_in.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_data_in.sh [-help]\n\
Usage: ila_data_in.sh [-step]\n\
Usage: ila_data_in.sh [-lib_map_path]\n\
Usage: ila_data_in.sh [-reset_run]\n\
Usage: ila_data_in.sh [-reset_log]\n\
Usage: ila_data_in.sh [-keep_index]\n\
Usage: ila_data_in.sh [-noclean_files]\n\n\
