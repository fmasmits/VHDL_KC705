...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../sources/ip/vio_TX/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_TX/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_TX xil_defaultlib.glbl -o vio_TX_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_TX_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_TX_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_TX_simv.daidir vcs_lib c.obj)
