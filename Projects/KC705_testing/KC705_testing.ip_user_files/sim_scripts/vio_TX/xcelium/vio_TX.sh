...
#
# Script generated by Vivado on Wed Dec 18 11:07:00 CET 2024
...
#
# Usage        : vio_TX.sh
#                vio_TX.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_TX.sh [-reset_run]
#                vio_TX.sh [-reset_log]
#                vio_TX.sh [-help]
#
...
#                script (type 'vio_TX.sh -help' for more information).
#
...
# script info
echo -e "vio_TX.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_TX.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../sources/ip/vio_TX/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_TX/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_TX xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_TX -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_TX_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_TX.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_TX.sh [-help]\n\
Usage: vio_TX.sh [-step]\n\
Usage: vio_TX.sh [-lib_map_path]\n\
Usage: vio_TX.sh [-reset_run]\n\
Usage: vio_TX.sh [-reset_log]\n\
Usage: vio_TX.sh [-keep_index]\n\
Usage: vio_TX.sh [-noclean_files]\n\n\
