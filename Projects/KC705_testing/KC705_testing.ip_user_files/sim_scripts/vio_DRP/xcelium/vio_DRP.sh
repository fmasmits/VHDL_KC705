...
#
# Script generated by Vivado on Wed Dec 18 11:17:30 CET 2024
...
#
# Usage        : vio_DRP.sh
#                vio_DRP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_DRP.sh [-reset_run]
#                vio_DRP.sh [-reset_log]
#                vio_DRP.sh [-help]
#
...
#                script (type 'vio_DRP.sh -help' for more information).
#
...
# script info
echo -e "vio_DRP.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_DRP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../sources/ip/vio_DRP/hdl/verilog" +incdir+"../../../../../../sources/ip/vio_DRP/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_DRP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_DRP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_DRP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_DRP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_DRP.sh [-help]\n\
Usage: vio_DRP.sh [-step]\n\
Usage: vio_DRP.sh [-lib_map_path]\n\
Usage: vio_DRP.sh [-reset_run]\n\
Usage: vio_DRP.sh [-reset_log]\n\
Usage: vio_DRP.sh [-keep_index]\n\
Usage: vio_DRP.sh [-noclean_files]\n\n\
